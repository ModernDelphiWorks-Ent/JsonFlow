...
begin
  ...
  try
    ...
    try
      ...
      Assert.AreEqual('{"Name":"Jo?o","Age":30,"IsActive":true,"Score":95.5}', LJson.AsJSON);
    finally
      LObj.Free;
    end;
  finally
...
begin
  ...
  try
    ...
    try
      ...
      LJson.Add('Name', TJSONValueString.Create('Jo?o'));
...
begin
  ...
  try
    ...
    try
      ...
      Assert.AreEqual('{"$class":"TTestSimpleClass","Name":"Jo?o","Age":0,"IsActive":false,"Score":0}', LJson.AsJSON);
    finally
      LObj.Free;
    end;
  finally
...
begin
  ...
  try
    ...
    try
      ...
      LObj.Inner.Name := 'Jo?o';
      LObj.Inner.Age := 30;
      LJson := LSerializer.FromObject(LObj);
      Assert.AreEqual('{"Inner":{"Name":"Jo?o","Age":30,"IsActive":false,"Score":0},"Scores":[]}', LJson.AsJSON);
    finally
      LObj.Inner.Free;
      LObj.Free;
    end;
